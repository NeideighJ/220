...
def rectangle():
    ...
    instructions2 = Text(Point(400/2 , 360 ), "The perimeter is: " + str(perimeter))
    instructions.draw(win)
    instructions2.draw(win)


    inst_pt = Point(400 / 2, 10)
    instructions3 = Text(inst_pt, "Click again to close")
...
def circle():
    ...
    inst_pt = Point(400 / 2, 10)
    instructions2 = Text(inst_pt, "Click again to close" )
    instructions2.draw(win)
